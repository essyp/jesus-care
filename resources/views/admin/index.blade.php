                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="panel short-states bg-primary">
                                    ...
                                    <div class="panel-body">
                                        <h1 class="light-txt">{{$totalMinistry}}</h1>
                                        <div class=" pull-right">{{$totalMinistry}} <i class="fa fa-level-up"></i></div>
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        <div class="order-short-info">
                                            <a href="{{url('/admin/users')}}" class="pull-right pull-left-xs btn btn-primary btn-sm">View All Quotes</a>
                                        </div>
                                        <hr/>
