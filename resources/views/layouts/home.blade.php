...
<head>
    <title>{{$comm->com_shortname}} - @yield('title')</title>
    <meta charset="UTF-8">
        ...
        <nav id="navigation4" class="container navigation">
            <div class="nav-header">
                <a class="nav-brand" href="{{url('/')}}">
                    <img src="{{asset('images/logo/'.$comm->logo)}}" alt="logo" style="max-height: 70px; max-width: 130px" class="main-logo" id="light_logo">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        ...
                        <ul class="footer-news mt-25">
                            ...
                            <li>
                                <a href="{{url('news/'.$fb->url)}}">{{$fb->title}}</a>
