    ...
    <div class="blog-post-right">
        ...
        <div class="blog-post-categories mt-20">
            <ul  class="vertical-nav-1 mt-15">
                @foreach ($ministry as $page)
                <li><a href="{{url('ministry/'.$page->slug)}}">{{$page->name}}</a></li>
                @endforeach
            </ul>
        </div>
       ...
       <h4 class="blog-widget-title">Connect With Us</h4>
        <div class="blog-post-follow mt-20">
            <ul>
                <li class="social-link"><a href="{{$comm->facebook}}" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                <li class="social-link"><a href="{{$comm->youtube}}" target="_blank"><i class="fab fa-youtube"></i></a></li>
                <li class="social-link"><a href="{{$comm->twitter}}" target="_blank"><i class="fab fa-twitter"></i></a></li>
                <li class="social-link"><a href="{{$comm->instagram}}" target="_blank"><i class="fab fa-instagram"></i></a></li>
                <li class="social-link"><a href="{{$comm->linkedin}}" target="_blank"><i class="fab fa-linkedin"></i></a></li>
            </ul>
        </div>
    </div>
</div>
